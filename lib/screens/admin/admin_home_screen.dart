...
class _AdminHomeScreenState extends State<AdminHomeScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await _loadStats();
      _startAdminNotificationPolling(); // ← NEW
      _fadeCtrl.forward();
    });
  }

  // ── Start polling open support-ticket count ──────────────────────────────
  void _startAdminNotificationPolling() {
    final auth = Provider.of<AuthProvider>(context, listen: false);
    if (auth.token != null) {
      Provider.of<AdminNotificationProvider>(context, listen: false)
          .startPolling(auth.token!);
    }
  }
      ...
      if (auth.token != null) {
        ...
        if (mounted)
          setState(() {
            ...
            _todayLiters =
                todayCols.fold(0.0, (s, c) => s + c.quantityInLiters);
      ...
      appBar: AppBar(
        ...
        title: const Text('ADMIN PORTAL',
            style: TextStyle(
                ...
                color: _light)),
        actions: [
          // ── Support-ticket bell with badge (NEW) ─────────────────────
          Consumer<AdminNotificationProvider>(
            builder: (context, adminNotif, _) => GestureDetector(
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => AdminSupportScreen()),
              ),
              child: Stack(
                  ...
                  if (adminNotif.hasUnread)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            adminNotif.openTicketCount > 9
                                ? '9+'
                                : '${adminNotif.openTicketCount}',
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // ── Support-ticket alert banner (NEW) ──────────────────
                _AdminSupportBanner(),
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      ...
                      _DarkCard(
                        ...
                        badge: Consumer<AdminNotificationProvider>(
...
// ══════════════════════════════════════════════════════════════════════════
//  ADMIN SUPPORT BANNER  (NEW)
//  Shows when there are open/unread support tickets.
// ══════════════════════════════════════════════════════════════════════════

class _AdminSupportBanner extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer<AdminNotificationProvider>(
      builder: (context, notif, _) {
        ...
        final count = notif.openTicketCount;
        final label = count == 1
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              shape: BoxShape.circle,
                              border: Border.all(
                                  color: const Color(0xFFFDF4FF), width: 1.5),
                            ),
                            child: Center(
                              child: Text(
                                count > 9 ? '9+' : '$count',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                              fontSize: 12, color: Color(0xFFA855F7)),
                        ),
                      ],
                    ),
                  ),
...
class _DarkCard extends StatelessWidget {
  ...
  final Widget? badge; // ← optional badge overlay
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(col.collectionStatus,
                          style: TextStyle(
                              fontSize: 9,
                              fontWeight: FontWeight.w700,
                              color: dotColor)),
